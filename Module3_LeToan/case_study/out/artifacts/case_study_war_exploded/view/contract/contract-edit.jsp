        ...
        <form method="post">
            <fieldset>
                ...
                <div class="form-group form-inline">
                    ...
                    <input type="date" class="col-8 form-control" id="startDate" name="startDate" value="${contract.contractStartDate}">
                </div>
                <div class="form-group form-inline">
                    <label for="endDate" class="col-2 d-flex justify-content-start">End Date</label>
                    <input type="date" class="col-8 form-control" id="endDate" name="endDate" value="${contract.contractEndDate}">
                </div>
                <div class="form-group form-inline">
