...
public class Regex {
    ...
    public static boolean checkRegexIdNumber(String input){
    ...
    public static boolean checkRegexIntegerNumber(String input){
        Pattern pattern = Pattern.compile(REGEX_INTEGER);
        Matcher matcher = pattern.matcher(input);
        return matcher.matches();
    }

    public static boolean checkRegexDoubleNumber(String input) {
    ...
    public static boolean checkRegexFloor(String input){
        Pattern pattern = Pattern.compile(REGEX_INTEGER);
        Matcher matcher = pattern.matcher(input);
        return matcher.matches() && (Integer.parseInt(input) > 0) && (Integer.parseInt(input) < 16);
    }

    public static boolean checkRegexArea(String input){
        Pattern pattern = Pattern.compile(REGEX_DOUBLE);
        Matcher matcher = pattern.matcher(input);
        return matcher.matches() && (Double.parseDouble(input) > 20);
    }

    public static boolean checkRegexCost(String input){
        Pattern pattern = Pattern.compile(REGEX_DOUBLE);
        Matcher matcher = pattern.matcher(input);
        return matcher.matches() && (Double.parseDouble(input) > 1000000);
    }
}